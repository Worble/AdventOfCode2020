...
using AdventOfCode2020.DayFour;
using Xunit;

namespace AdventOfCode2020.Test.DayFourTest
{
	public class DayFourSolutionTest
	{
		[Theory]
...
iyr:2011 ecl:brn hgt:59in", 2)]
		[InlineData(@"iyr:2013 hcl:#ceb3a1
hgt:151cm eyr:2030
byr:1943 ecl:grn
...
ecl:amb", 208)]
		public void SumValidPassports_ReturnsTheAmountOfInvalidPassports(string input, int expected)
		{
			//arrange
			...
			var dayFour = new DayFourSolution(input, requiredFields);

			//act
			var actual = dayFour.SumValidPassports();
...
byr:2001 hcl:#4784a2 hgt:161cm iyr:2014 eyr:2025 pid:955262336
ecl:amb", 167)]
		public void SumValidPassportsWithValidators_ReturnsTheAmountOfInvalidPassports(string input, int expected)
		{
			//arrange
			var requiredFields = new List<string>
			{
			...
			//act
			var actual = dayFour.SumValidPassportsWithValidators();
