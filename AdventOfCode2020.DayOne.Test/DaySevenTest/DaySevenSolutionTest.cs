using AdventOfCode2020.DaySeven;
using Xunit;

namespace AdventOfCode2020.Test.DaySevenTest
{
	public class DaySevenSolutionTest
	{
		[Theory]
...
dotted black bags contain no other bags.", 4)]
		[InlineData(@"plaid magenta bags contain 2 clear lavender bags, 3 clear teal bags, 4 vibrant gold bags.
...
bright brown bags contain 2 dotted green bags, 4 clear tan bags, 3 wavy red bags.", 208)]
		public void FindHoldingBag_ReturnsAmountOfBagsThatHoldTheBag(string input, int expected)
		{
			//arrange
			var daySeven = new DaySevenSolution(input);

			//act
			var result = daySeven.FindHoldingBag("shiny gold bags");
...
dotted beige bags contain 2 shiny fuchsia bags, 3 faded cyan bags, 5 mirrored red bags, 3 drab turquoise bags.
drab purple bags contain 3 bright cyan bags, 1 faded bronze bag, 3 light plum bags, 1 dull fuchsia bag.
bright brown bags contain 2 dotted green bags, 4 clear tan bags, 3 wavy red bags.", 1664)]
		public void FindTotalBagCount_ReturnsTotalBagCount(string input, int expected)
		{
			//arrange
			var daySeven = new DaySevenSolution(input);

			//act
			var result = daySeven.FindTotalBagCount("shiny gold bags");
