using AdventOfCode2020.DaySix;
using Xunit;

namespace AdventOfCode2020.Test.DaySixTest
{
	public class DaySixSolutionTest
	{
		[Theory]
		[InlineData(@"abc
...
l
hyue", 3473)]
		public void SumGroupYes_ReturnsTotalGroupSumsOfYes(string input, int expected)
		{
			//arrange
			var daySix = new DaySixSolution(input);

			//act
			var actual = daySix.SumGroupYes();
...
l
hyue", 6911)]
		public void SumIndividualYes_ReturnsTotalSumOfYes(string input, int expected)
		{
			//arrange
			var daySix = new DaySixSolution(input);

			//act
			var actual = daySix.SumIndividualYes();
